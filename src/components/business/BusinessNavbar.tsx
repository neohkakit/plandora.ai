    ...
    <header className="sticky top-0 z-50 w-full border-b border-[#d9d9d9] bg-white">
      <nav className="flex h-[50px] items-stretch" aria-label="Primary navigation">
        ...
        <Link
          ...
          className="flex min-w-[120px] shrink-0 items-center justify-center bg-[#008DFF] px-3 text-[14px] font-medium text-white transition-colors hover:bg-[#0078E0] sm:min-w-[147px] sm:px-5"
        >
          Talk to Sales
        </Link>
      </nav>
